    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.customer')),
            ],
        ),
        migrations.CreateModel(
            name='HomeDelivery',
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.order')),
            ],
        ),
        migrations.CreateModel(
            name='Bill',
            fields=[
                ...
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.discount')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.order')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(auto_now_add=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.product')),
            ],
        ),
        migrations.CreateModel(
            name='ProductItem',
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.item')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.product')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gasharusstore.supplier')),
            ],
        ),
    ]
